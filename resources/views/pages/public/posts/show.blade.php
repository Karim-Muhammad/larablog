...
-->
        ...
        <main class="pt-8 pb-16 lg:pt-16 lg:pb-24 bg-white text-black dark:bg-gray-900 antialiased">
            <div class="flex justify-between px-4 mx-auto max-w-screen-xl ">
                <article
                    ...
                    <header class="mb-4 lg:mb-6 not-format">
                        <address class="flex items-center mb-6 not-italic">
                            <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                                <img class="mr-4 w-16 h-16 rounded-full" src="{{ asset('storage/' . $author->image) }}"
                                    alt="Jese Leos">
                                <div>
                                    <a href="#" rel="author"
                                        class="text-xl font-bold text-gray-900 dark:text-white">{{ $author->name }}</a>
                                    <p class="text-base text-gray-500 dark:text-gray-400">
                                        <span class="description text-slate-600 dark:text-blue-500">
                                            {{ $author->description }}
                                        </span>
                                        -
                                        <span class="work_on text-slate-600 dark:text-blue-400">
                                            {{ $author->work_on }}
                                        </span>
                                    </p>
                    ...
                    <div>
                        <img src="{{ asset('storage/' . $post->image) }}" alt="Image" class="mb-6 rounded-lg">
                    </div>
                    ...
                    <section class="not-format mt-8">
                        ...
                        @include('pages.admin.posts.components.comments', ['comments' => $post->comments])
            ...
            <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                <div class="mx-auto max-w-screen-md sm:text-center">
                    ...
                    <p class="mx-auto mb-8 max-w-2xl  text-gray-500 md:mb-12 sm:text-xl dark:text-gray-400">Stay up to
                        date with the roadmap progress, announcements and exclusive discounts feel free to sign up with
                        your email.</p>
                    <form action="#">
        ...
        <footer class="bg-gray-50 dark:bg-gray-800 antialiased">
            <div class="p-4 py-6 mx-auto max-w-screen-xl md:p-8 lg:p-10">
                ...
                <div class="text-center">
                    ...
                    <span class="block text-sm text-center text-gray-500 dark:text-gray-400">© 2021-2022 <a
