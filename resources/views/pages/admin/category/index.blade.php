<x-app-layout>
    ...
    <x-slot name="content">
        <div>
            <a href="{{ route('admin.category.create') }}" class="bg-green-700 text-white py-2 px-4">Add Category</a>
        </div>
                    ...
                    <tr class="p-3 odd:bg-black odd:text-white even:bg-slate-700 even:text-gray-50">
                        ...
                        <td>
                            <div class="flex justify-center">
                                ...
                                <x-form-data method="post" http-method="DELETE" class="mx-[auto] w-full my-7 max-w-sm" action="{{ route('admin.category.destroy', $category->id) }}">
                                    <a class="block py-2 px-4 bg-indigo-300 text-black" href="{{ route('admin.category.edit', $category->id) }}">Edit</a>
