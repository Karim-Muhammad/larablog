        ...
        <div class="container text-white">
            ...
            <form class="w-full mx-[auto] my-7 max-w-sm" method="POST" action="{{route('admin.category.store')}}">
                ...
                <div class="flex items-center border-b border-teal-500 py-2">
                    <input name="name" class="@error('name') is-invalid @enderror appearance-none bg-transparentborder-none w-full text-black mr-3 py-1 px-2 leading-tight focus:outline-none" type="text" placeholder="Jane Doe" aria-label="Full name">
