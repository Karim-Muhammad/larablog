<x-app-layout>
    ...
    <x-slot name="content">
        <div class="container text-white">
            ...
            <form class="w-full mx-[auto] my-7 max-w-sm" method="POST"
                ...
                <div class="flex items-center border-b border-teal-500 py-2">
                    <input name="name" value="{{ $tag->name }}"
                        class="@error('name') is-invalid @enderror appearance-none bg-transparent dark:text-white border-none w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none"
